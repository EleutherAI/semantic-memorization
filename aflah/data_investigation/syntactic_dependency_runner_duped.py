...
ls_first_64_tokens_string = df_duped_pythia['first_64_tokens_string'].to_list()
...
for doc in tqdm(ls_docs):
    ls_dependency_lengths_duped.append(get_avg_dependency_length(doc))
...
import pickle
# save docs
with open("../data/ls_docs_full_duped.pkl", "wb") as f:
    pickle.dump(ls_docs, f)
# save the list of average dependency lengths for each sentence
with open("../data/ls_dependency_lengths_full_duped.pkl", "wb") as f:
    pickle.dump(ls_dependency_lengths_duped, f)

df_duped_pythia['dependency_length'] = ls_dependency_lengths_duped
df_duped_pythia['docs'] = ls_docs

df_duped_pythia.to_pickle("../data/df_duped_pythia_full_with_dependency_length.pkl")